...
<nav class="navbar navbar-expand-lg navbar-dark
  ...
  <div class="container">
    ...
    <div class="ms-auto d-flex align-items-center gap-3">
      ...
      <?php if ($role === 'admin'): ?>
        <a href="<?= base_url('dashboard') ?>"    class="btn btn-outline-light btn-sm">Dashboard</a>
        <a href="<?= base_url('admin/roles') ?>"  class="btn btn-outline-light btn-sm">Roles</a>
        <a href="<?= base_url('admin/users') ?>"  class="btn btn-outline-light btn-sm">Users</a>
      ...
      <?php else: ?>
        <a href="<?= base_url('student/dashboard') ?>" class="btn btn-outline-light btn-sm">Dashboard</a>
        <a href="<?= base_url('profile') ?>"           class="btn btn-outline-light btn-sm">Profile</a>
      <?php endif; ?>

      <a href="<?= base_url('logout') ?>" class="btn btn-sm btn-light text-danger fw-semibold">Logout</a>
